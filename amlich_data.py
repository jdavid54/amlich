...
# giờ Sóc (New Moons), Trung khí (Major Solar Term) và Tiết khí (Minor Solar Terms) c
...
class YearlyEvent():
    ...
    def __repr__(self):
        return str(self.day) + '/' + str(self.month) + ' : ' + self.info
...
class OutputOptions():
    def __init__(self):
        self.fontSize = "13pt";
        self.tableWidth = "420px";

DAYNAMES = ("CN", "T2", "T3", "T4", "T5", "T6", "T7");
PRINT_OPTS = OutputOptions();
